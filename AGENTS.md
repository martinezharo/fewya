...
## Privacy
Be careful of never expose real user, customer, seller, employee, or other private application data in any public artifact; use clearly fictitious or properly anonymized data instead.
