...
CREATE TABLE public.orders (
  ...
  payment_status text NOT NULL DEFAULT 'pending'::text CHECK (payment_status IN ('pending', 'paid')),
  ...
  delivery_type text DEFAULT 'home' CHECK (delivery_type IN ('home', 'pickup_point')),
