/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 985b99827614913b4c2103f94179dc01)
// Runtime types generated with workerd@1.20260312.1 2024-09-23 nodejs_compat_v2
declare namespace Cloudflare {
	interface Env {
		ASSETS: Fetcher;
		PACKLINK_SENDER_NAME: "Shopenn";
		PACKLINK_SENDER_COMPANY: "Shopenn Marketplace";
		SUPABASE_URL: string;
		SUPABASE_KEY: string;
		STRIPE_SECRET_KEY: string;
		PACKLINK_API_KEY: string;
		PACKLINK_SENDER_ADDRESS: string;
		PACKLINK_SENDER_CITY: string;
		PACKLINK_SENDER_POSTAL_CODE: string;
		PACKLINK_SENDER_COUNTRY: string;
		PACKLINK_SENDER_PHONE: string;
		PACKLINK_SENDER_EMAIL: string;
	}
}
